...
#------------------------------------------contratos----------------------------#
    ...
    #-------------------------------------------AccionpermitidaHasUsuario--------------------------------------------# 
     path('AccionpermitidaHasUsuario/', ListadoAccionpermitidaHasUsuario.as_view(template_name = "crud\ccionpermitidaHasUsuario\index.html"), name='leerhasusu'),
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Contratos o registro  
    path('AccionpermitidaHasUsuario/crear',  AccionpermitidaHasUsuarioCrear.as_view(template_name = "crud\ccionpermitidaHasUsuario\crear.html"), name='crearhasusu'),
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un Contratos o registro 
    path('AccionpermitidaHasUsuario/detalle/<int:pk>', AccionpermitidaHasUsuarioDetalle.as_view(template_name = "crud\ccionpermitidaHasUsuario\detalle.html"), name='detallehasusu'),
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Contratos o registro de la Base de Datos 
    path('AccionpermitidaHasUsuario/editar/<int:pk>', AccionpermitidaHasUsuarioActualizar.as_view(template_name = "crud\ccionpermitidaHasUsuario\eactualizar.html"), name='actualizarhasusu'), 
    # La ruta 'eliminar' que usaremos para eliminar un Contratos o registro de la Base de Datos 
    ...
    #---------------------------------------Cronograma-------------------------------------------------#
    path('Cronograma/',  ListadoCronograma.as_view(template_name = "crud\cronograma\index.html"), name='leercrono'),
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Contratos o registro  
    path('Cronograma/crear', CronogramaCrear.as_view(template_name = "crud\cronograma\crear.html"), name='crearcro'),
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un Administradors o registro 
    path('Cronograma/detalle/<int:pk>', CronogramaDetalle.as_view(template_name = "crud\cronograma\detalle.html"), name='detallecrono'),
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Administradors o registro de la Base de Datos 
    path('Cronograma/editar/<int:pk>', CronogramaActualizar.as_view(template_name = "crud\cronograma\eactualizar.html"), name='actualizarcrono'), 
...
#---------------------------------------------Estatipgen---------------------------------------------#
    path('estatipgen/',  ListadoEstatipgen.as_view(template_name = "crud\estatipgen\index.html"), name='leerestagenemusi'),
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Contratos o registro  
    path('estatipgen/crear', EstatipgenCrear.as_view(template_name = "crud\estatipgen\crear.html"), name='crearestagenemusi'),
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un Estatipgens o registro 
    path('estatipgen/detalle/<int:pk>', EstatipgenDetalle.as_view(template_name = "crud\estatipgen\detalle.html"), name='detalleestagenemusi'),
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Estatipgens o registro de la Base de Datos 
    path('estatipgen/editar/<int:pk>', EstatipgenActualizar.as_view(template_name = "crud\estatipgen\eactualizar.html"), name='actualizarestagenemusi'), 
...
#---------------------------------------------Organizador---------------------------------------------#
    path('organizador/',  ListadoOrganizador.as_view(template_name = "crud\organizador\index.html"), name='leerrut'),
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Contratos o registro  
    path('organizador/crear', OrganizadorCrear.as_view(template_name = "crud\organizador\crear.html"), name='crearrut'),
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un Organizadors o registro 
    path('organizador/detalle/<int:pk>', OrganizadorDetalle.as_view(template_name = "crud\organizador\detalle.html"), name='detallerut'),
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Organizadors o registro de la Base de Datos 
    path('organizador/editar/<int:pk>', OrganizadorActualizar.as_view(template_name = "crud\organizador\eactualizar.html"), name='actualizarrut'), 
    # La ruta 'eliminar' que usaremos para eliminar un Organizadors o registro de la Base de Datos 
...
#---------------------------------------------Telefono---------------------------------------------#
    path('Telefono/',  ListadoTelefono.as_view(template_name = "crud\Telefono\index.html"), name='leeTelefono'),
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Contratos o registro  
    path('Telefono/crear', TelefonoCrear.as_view(template_name = "crud\Telefono\crear.html"), name='creaTelefono'),
    ...
    path('Telefono/editar/<int:pk>', TelefonoActualizar.as_view(template_name = "crud\Telefono\eactualizar.html"), name='actualizaTelefono'), 
...
# #---------------------------------------------Tipoartista---------------------------------------------#
    path('Tipoartista/',  ListadoTipoartista.as_view(template_name = "crud\Tipoartista\index.html"), name='leeTipoartista'),
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Contratos o registro  
    path('Tipoartista/crear', TipoartistaCrear.as_view(template_name = "crud\Tipoartista\crear.html"), name='creaTipoartista'),
    ...
    path('Tipoartista/editar/<int:pk>', TipoartistaActualizar.as_view(template_name = "crud\Tipoartista\eactualizar.html"), name='actualizaTipoartista'), 
